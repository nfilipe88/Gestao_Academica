...
from app.api.v1 import academico, admin, alunos, auditoria, auth, comunicacoes, configuracoes, crm, diario, documentos, financeiro, horarios, indicadores, lms, matriculas, notificacoes, perfil, permissoes, portal, professores, propinas, publico, tarefas, transferencias, usuarios
